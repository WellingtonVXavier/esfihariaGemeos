        ...
        if ($mostra->rowCount() > 0) {
            while ($linha = $mostra->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <a href="exclui.php?id_pessoa=<?php echo $linha['id_pessoa']; ?>" data-toggle="tooltip" data-placement="right"
                            title="Excluir">
                    ...
                    if ($linha['ativo'] == 1) {
                        ?>
                        <td class="text-center align-middle">
                            <a href="desativa.php?id_pessoa=<?php echo $linha['id_pessoa']; ?>" data-toggle="tooltip" data-placement="right"
                                title="Ativado, deseja desativar?">
                        ...
                        ?>
                        <td class="text-center align-middle">
                            <a href="ativa.php?id_pessoa=<?php echo $linha['id_pessoa']; ?>" data-toggle="tooltip" data-placement="right"
                                title="Desativado, deseja ativar?" class="text-danger">
                    ...
                    <td class="text-center align-middle">
                        <a href="imprimir.php?id_pessoa=<?php echo $linha['id_pessoa']; ?>" data-toggle="tooltip" data-placement="right"
                            title="Imprimir">
