...
<body class="h-100 d-flex flex-column">
    <h3 class="alert text-center shadow no-print mb-0" style="background-color: #5b1a29 !important; color: rgba(0,0,0,255); border: none;">
        <a href="index.php" style="text-decoration: none; color: #FDD738; font-family: papyrus"><i class="fa-solid fa-fire-flame-curved" style="color: #FDD738;"></i>Esfiharia Gêmeos</a>
        ...
        ?>
            <div class="dropdown dropleft" style="float: right">
                ...
                <div class="dropdown-menu" style="width: 200px">
                    ...
                    <a class="dropdown-item text-center" href="#">Cadastre-se agora!</a>
                </div>
            </div>
